...
const styles = StyleSheet.create({
  ...
  toggleButton: { flex: 1, paddingVertical: 10, borderRadius: 6, borderWidth: 1, alignItems: "center", minWidth: 80 },
  ...
  saveButton: { borderRadius: 6, paddingVertical: 10, alignItems: "center" },
